...
- (void)loadView
{
    ...
    self.view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, FM_SCREEN_WIDTH, FM_SCREEN_HEIGHT)];
    ...
    self.cameraToolBarImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, FM_SCREEN_WIDTH,64)];
    ...
    self.cameraCaptureBarImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, FM_SCREEN_HEIGHT-54, FM_SCREEN_WIDTH, 54)];
    ...
    self.toggleFiltersButton.frame = CGRectMake(270, FM_SCREEN_HEIGHT-47, 40, 40);
    ...
    if (self.isInVideoRecorderMode == NO) {
        ...
        self.photoAlbumButton.frame = CGRectMake(10, FM_SCREEN_HEIGHT-47, 40, 40);
    ...
    if (self.isInVideoRecorderMode == NO) {
        ...
        self.shootButton.frame = CGRectMake(110, FM_SCREEN_HEIGHT-47, 100, 40);
    ...
    self.filterTableViewContainerView = [[UIView alloc] initWithFrame:CGRectMake(0, FM_SCREEN_HEIGHT-126, FM_SCREEN_WIDTH, 72)];
    ...
    self.cameraTrayImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 43, FM_SCREEN_WIDTH, 29)];
